...
public class MauiUtils
{
    ...
    public static string GetiPhoneModel()
    {
        ...
        switch (deviceName)
        {
            ...
            case "iPad13,5":
            case "iPad13,6":
            case "iPad13,7": return "iPad Pro 11 5th Gen WiFi";
            case "iPad13,8":
            case "iPad13,9":
            case "iPad13,10":
            case "iPad13,11": return "iPad Pro 12.9 5th Gen WiFi";
            case "iPad13,16": return "iPad Air 5th Gen WiFi";
            case "iPad13,17": return "iPad Air 5th Gen WiFi LTE";
            case "iPad13,18": return "iPad 10th Gen";
            case "iPad13,19": return "iPad 10th Gen";
            case "iPad14,3":
            case "iPad14,4": return "iPad Pro 11 4th Gen";
            case "iPad14,5":
            case "iPad14,6": return "iPad Pro 12.9 4th Gen";
            case "iPad14,8":
            case "iPad14,9": return "iPad Air 6th Gen";
            case "iPad14,10":
            case "iPad14,11": return "iPad Air 7th Gen";
            case "iPad16,3":
            case "iPad16,4": return "iPad Pro 11 5th Gen";
            case "iPad16,5":
            case "iPad16,6": return "iPad Pro 12.9 7th Gen";
